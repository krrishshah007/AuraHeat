const initialWeather = [
  ...
  { id: '11', state: 'Madhya Pradesh', city: 'Bhopal', latitude: 23.2599, longitude: 77.4126, temperature: 41.9, humidity: 40, windSpeed: 14.5, heatIndex: 45.1, uvIndex: 9, aqi: 175, rainfall: 0, riskLevel: 'High', populationAtRisk: 2400000 },
  { id: '12', state: 'Punjab', city: 'Amritsar', latitude: 31.6340, longitude: 74.8723, temperature: 43.0, humidity: 34, windSpeed: 16.8, heatIndex: 46.7, uvIndex: 10, aqi: 205, rainfall: 0, riskLevel: 'Extreme', populationAtRisk: 1300000 }
];
...
const initialAlerts = [
  ...
  {
    _id: 'alert_4',
    title: 'YELLOW ALERT: Coastal Heat Index Rise',
    city: 'Kolkata',
    state: 'West Bengal',
    severity: 'Moderate',
    temperature: 40.5,
    heatIndex: 48.1,
    advisoryText: 'High coastal humidity contributing to heat index exceeding 48°C. Stay hydrated and monitor symptoms of heat exhaustion.',
    active: true,
...
const initialPredictions = [
  {
    ...
    recommendations: [
      'Issue immediate Red Alert public broadcast across radio, SMS, and digital channels',
      'Suspend outdoor construction & physical agricultural labor between 10:30 AM - 4:30 PM',
      'Deploy mobile hydration units & emergency cooling stations in public squares',
      'Alert hospital emergency response teams for surge in heatstroke admissions',
      'Advise school morning shifts only & mandate indoor cooling'
    ],
    forecast: { h24: 45.5, d3: 46.2, d7: 43.8 },
    timestamp: new Date()
  }
];
...
const initialUsers = [
  {
    _id: 'user_admin',
    name: 'Dr. Rajesh Sharma (NDMA Lead)',
    email: 'admin@aurheat.gov.in',
    password: '$2a$10$wT5i2d9eKqH/U0vS7i7A3.e9x9Z9y1v2w3x4y5z6a7b8c9d0e1f2g', // hashed admin123
    role: 'admin',
  ...
  },
  {
    _id: 'user_demo',
    name: 'Ananya Verma',
    email: 'user@aurheat.com',
    password: '$2a$10$wT5i2d9eKqH/U0vS7i7A3.e9x9Z9y1v2w3x4y5z6a7b8c9d0e1f2g', // hashed user123
    role: 'user',
    organization: 'Climate Research Fellow',
    location: 'Ahmedabad',
    createdAt: new Date()
  }
];

module.exports = { initialWeather, initialAlerts, initialPredictions, initialUsers };
